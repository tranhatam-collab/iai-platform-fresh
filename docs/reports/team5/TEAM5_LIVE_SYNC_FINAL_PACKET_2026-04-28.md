...
- Thời điểm tạo: 2026-04-28T06:35:17.669Z
- Múi giờ: Asia/Ho_Chi_Minh
- Trạng thái live-sync: NOT_READY_FOR_SYNCHRONIZED_LIVE
- Release-claim state: UNKNOWN
...
BLOCK:
- Owner sign-off NO-GO chưa hoàn tất.
- Pay production gate chưa pass.
...
- Chỉ chuyển live-sync khi hoàn tất các điều kiện còn thiếu: 4 owner sign-off NO-GO + pay production gate PASS + release-claim state thoát LOCK_RETAINED.

TEST PROOF:
- `pnpm report:team5-gate-flow`
- `pnpm report:team5-live-sync-readiness -- --date=2026-04-28`
- `pnpm report:team5-live-sync-packet -- --date=2026-04-28`
...
Sources:
- docs/reports/team5/TEAM5_LIVE_SYNC_READINESS_2026-04-28.json
- docs/reports/team5/WEB_KPI_BUNDLE_2026-04-28.json
