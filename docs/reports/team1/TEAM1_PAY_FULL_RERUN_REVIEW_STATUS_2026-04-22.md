# TEAM1_PAY_FULL_RERUN_REVIEW_STATUS_2026-04-22
- Generated at: 2026-04-22T15:37:17.497Z
- Timezone: Asia/Ho_Chi_Minh
- Status: `REVIEW_BLOCKED_PRECHECK`

## Artifact checks
- PASS `bundle_markdown` — `docs/reports/team2/TEAM2_PAY_PROD_RERUN_BUNDLE_STATUS_2026-04-22.md`
- PASS `bundle_json` — `docs/reports/team2/TEAM2_PAY_PROD_RERUN_BUNDLE_STATUS_2026-04-22.json`
- PASS `runtime_probe_markdown` — `docs/reports/team2/TEAM2_PAY_PROD_RUNTIME_PROBE_2026-04-22.md`
- PASS `runtime_probe_json` — `docs/reports/team2/TEAM2_PAY_PROD_RUNTIME_PROBE_2026-04-22.json`
- PASS `shared_runtime_probe_markdown` — `docs/reports/team2/TEAM2_PAY_SHARED_RUNTIME_PROBE_2026-04-22.md`
- PASS `shared_runtime_probe_json` — `docs/reports/team2/TEAM2_PAY_SHARED_RUNTIME_PROBE_2026-04-22.json`
- PASS `team1_gate_markdown` — `docs/reports/team1/TEAM1_PAY_PROD_GATE_STATUS_2026-04-22.md`
- PASS `team1_gate_json` — `docs/reports/team1/TEAM1_PAY_PROD_GATE_STATUS_2026-04-22.json`
...
## Gate signals
- FAIL `auth_key_present` — source: `docs/reports/team2/TEAM2_PAY_PROD_RUNTIME_PROBE_2026-04-22.json`
- FAIL `checkout_url_non_null` — source: `docs/reports/team2/TEAM2_PAY_PROD_RUNTIME_PROBE_2026-04-22.json`
- FAIL `payment_link_id_non_null` — source: `docs/reports/team2/TEAM2_PAY_PROD_RUNTIME_PROBE_2026-04-22.json`
- FAIL `no_214` — source: `docs/reports/team2/TEAM2_PAY_PROD_RUNTIME_PROBE_2026-04-22.json`
- FAIL `production_gate_green` — source: `docs/reports/team2/TEAM2_PAY_PROD_RUNTIME_PROBE_2026-04-22.json`
- FAIL `shared_read_model_ready_for_shared_only` — source: `docs/reports/team2/TEAM2_PAY_SHARED_RUNTIME_PROBE_2026-04-22.json`
- FAIL `shared_upstream_active_read_mode_shared_contract` — source: `docs/reports/team2/TEAM2_PAY_SHARED_RUNTIME_PROBE_2026-04-22.json`
- FAIL `shared_upstream_release_gate_ready` — source: `docs/reports/team2/TEAM2_PAY_SHARED_RUNTIME_PROBE_2026-04-22.json`
