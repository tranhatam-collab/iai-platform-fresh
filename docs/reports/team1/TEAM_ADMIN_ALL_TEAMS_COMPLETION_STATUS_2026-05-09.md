...
- Generated at: 2026-05-09T11:19:57.614Z
...
2. Team 1 must accept or reject the Team 2 CIOS closure packet; checker is PASS, and Team 2 stays monitor-only until the verdict is recorded.
3. Team Email SMTP must close 5 evidence clusters before live-close: mailbox/alias truth, inbound routing truth, Gmail proof, Outlook proof, internal inbox proof.
4. Team D must close tranhatam.com external activation evidence (mailbox/alias, runtime bindings, provider_ref, message_id, D1 row, inbox proof) before any READY_FOR_LIVE claim.
...
- Out-of-scope sample: apps/noos-web/src/i18n.ts, apps/noos-web/src/render.ts, content/en.json, content/seo-registry.csv, content/vi.json, ops/launchd/com.iai.team-autowake-15m.plist, scripts/team-autowake-15m-loop.mjs, scripts/team-channel-reminder-check.mjs
