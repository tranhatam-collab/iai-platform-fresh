# UNIVERSAL_BILINGUAL_LANGUAGE_REBUILD_AUDIT_2026-04-22
- Generated at: 2026-04-22T15:32:35.930Z
- Timezone: Asia/Ho_Chi_Minh
- Total URLs audited: 62
- Total pages flagged: 11
- Vietnamese issues open: 0
- English issues open: 0
- Metadata issues open: 0
- Alt text issues open: 0
- CTA/form/menu/footer issues open: 3
...
- Hard-coded candidate (quoted-copy): Chỉ thử lại khi chính sách hoặc hỗ trợ cho phép
- Hard-coded candidate (quoted-copy): Chi tiết thanh toán
- Hard-coded candidate (quoted-copy): Chuỗi phê duyệt
- Hard-coded candidate (quoted-copy): Cửa sổ chính sách
- Hard-coded candidate (quoted-copy): đã xác nhận
- Hard-coded candidate (quoted-copy): Điều người thanh toán cần biết
- Hard-coded candidate (quoted-copy): Điều route được phép nói
- Hard-coded candidate (quoted-copy): Do not grant powerful actions when the detail does not exist.
- Hard-coded candidate (quoted-copy): Do not skip reconciliation if the payer sent funds.
- Hard-coded candidate (quoted-copy): Đọc tài liệu hỗ trợ
...
- Hard-coded candidate (quoted-copy): : noindex ?
...
- noos-web (surface-root) (1 issues)
