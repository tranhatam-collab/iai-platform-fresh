# TEAM1_MULTILINGUAL_EXPANSION_READINESS_2026-04-19
...
Chuẩn bị sẵn nền mở rộng đa ngôn ngữ cho team dev mà không làm lệch nghĩa kỹ thuật hoặc phá release gate discipline.
...
- Team 1 automated language check: DONE (script + command)
  - `scripts/team1-language-compliance-check.mjs`
  - `pnpm report:team1-language`

## 3. Quy tắc mở rộng ngôn ngữ sau này

- Mỗi ngôn ngữ mới phải có:
  - glossary cục bộ,
  - reviewer owner,
  - checklist quality,
  - bằng chứng pass qua kiểm tra tự động và review thủ công.
...
## 5. Hành động tiếp theo (khi user yêu cầu mở ngôn ngữ mới)

1. Team 1 tạo bộ glossary cho ngôn ngữ đích theo mẫu.
2. Team 1 map owner reviewer + approval flow.
3. Team 1 mở checklist compliance cho lane tương ứng.
4. Team 1 chạy `report:team1-language` và cập nhật session log.
